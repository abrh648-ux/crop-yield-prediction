...
# ── Custom CSS — Agricultural Color Theme with Background ────────────────────
# Check if background image exists and convert to base64
background_image = ""
...
if os.path.exists(bg_path):
  ...
  [data-testid="stAppViewContainer"] > .main {{
      background: linear-gradient(rgba(255, 255, 255, 0.85), rgba(255, 255, 255, 0.85)),
                  url(data:image/jpeg;base64,{bg_data}) center/cover no-repeat fixed !important;
  }}
        """
else:
    background_image = """
